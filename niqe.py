...
if __name__ == "__main__":
    ...
    ref = np.array(Image.open('./test_imgs/image5301_hr.bmp').convert('LA'))[:,:,0] # ref
    dis = np.array(Image.open('./test_imgs/image5301_lr_out.bmp').convert('LA'))[:,:,0] # dis

    print('NIQE of hr image is: %0.3f'% niqe(ref))
    print('NIQE of sr image is: %0.3f'% niqe(dis))