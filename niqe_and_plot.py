...
if __name__ == "__main__":
    ...
    ref = np.array(Image.open('./test_imgs/image5301_hr.bmp').convert('LA'))[:,:,0] 
    dis1 = np.array(Image.open('./test_imgs/image5301_lr_out.bmp').convert('LA'))[:,:,0] 
    dis2 = np.array(Image.open('./test_imgs/image5301_lr_rlt.png').convert('LA'))[:,:,0] 

    print('NIQE of hr image is: %0.3f'% niqe(ref))
    print('NIQE of ESRGAN image is: %0.3f'% niqe(dis2))
    print('NIQE of Real-ESRGAN image is: %0.3f'% niqe(dis1))
